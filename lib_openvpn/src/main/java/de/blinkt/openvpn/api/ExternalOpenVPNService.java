...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    public static final String EXTRA_USER_NAME = "de.blinkt.openvpn.user_name";
    public static final String EXTRA_PASSWORD = "de.blinkt.openvpn.password";
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void updateProfileFromExtras(Bundle extras, VpnProfile vp) {
            if (extras != null) {
                ...
                vp.mUsername = extras.getString(EXTRA_USER_NAME, "");
                vp.mPassword = extras.getString(EXTRA_PASSWORD, "");
                VpnStatus.logDebug("got extra " + EXTRA_INLINE_PROFILE_ALLOW_VPN_BYPASS + ", mAllowAppVpnBypass=" + vp.mAllowAppVpnBypass);

                if (BuildConfig.DEBUG) {
                    Log.i(getClass().getSimpleName(),"updateProfileFromExtras-userName = " + vp.mUsername);
                    Log.i(getClass().getSimpleName(),"updateProfileFromExtras-password = " + vp.mPassword);
                }
            }
        }
...
//            return intent;
            ...
            //这里不需要弹首次的确认弹框直接返回null
            new ExternalAppDatabase(ExternalOpenVPNService.this).addApp(packageName);
            return null;
        }
