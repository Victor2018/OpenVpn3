...
public class LaunchVPN extends Activity {
    ...
    protected void startVpnFromIntent() {
        ...
        if (BuildConfig.DEBUG) {
            Log.i(getClass().getSimpleName(),"startVpnFromIntent-userName = " + profileToConnect.mUsername);
            Log.i(getClass().getSimpleName(),"startVpnFromIntent-password = " + profileToConnect.mPassword);
        }
        ...
        if (profileToConnect == null) {
            ...
            mTransientAuthPW = mSelectedProfile.mPassword;
